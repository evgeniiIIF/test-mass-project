...
(function () {
  function imagesSlider(slider) {
    ...
    var pagination = slider.querySelector(".js-pagination-slider");
    ...
    function positionSetting() {
      sliderLine.style.left = "".concat(linePosition, "%");
    }
    ...
    function setPagination() {
      var from = pagination.querySelector(".pagination-slider__from");
      var to = pagination.querySelector(".pagination-slider__to");
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;pug_mixins["field"] = pug_interp = function(opts){
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
pug_html = pug_html + "\u003Cdiv class=\"images-slider js-images-slider\"\u003E\u003Cdiv class=\"images-slider__filter-none\"\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"images-slider__line js-images-slider__line\"\u003E";
// iterate opts
;(function(){
  var $$obj = opts;
  if ('number' == typeof $$obj.length) {
...
pug_html = pug_html + "\u003Cdiv class=\"images-slider__slide js-images-slider__slide slide-slider\"\u003E\u003Cdiv class=\"slide-slider__image ibg\"\u003E\u003Cimg" + (" class=\"ibg__main-image\""+pug.attr("src", imgPath, true, true)+" alt=\"image room\"") + "\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"slide-slider__text\"\u003EДля примера мы показали вам его лицо.  В первой серии он прячется в подвале за мониторами, и пусть борода не собьёт вас с толку. Найдите героя и нажмите  на паузу — ему не терпится отдать вам промокод.\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"images-slider__control\"\u003E\u003Cdiv class=\"images-slider__control-previous js-images-slider__control-previous\"\u003E\u003Cimg" + (pug.attr("src", __webpack_require__(73), true, true)+" alt=\"arrow-prev\"") + "\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"images-slider__pagination pagination-slider js-pagination-slider\"\u003E\u003Cspan class=\"pagination-slider__from\"\u003E0\u002F\u003C\u002Fspan\u003E\u003Cspan class=\"pagination-slider__to\"\u003E9\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"images-slider__control-next js-images-slider__control-next\"\u003E\u003Cimg" + (pug.attr("src", __webpack_require__(252), true, true)+" alt=\"arrow-next\"") + "\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"images-slider__control-progress-none js-images-slider__control-progress\"\u003E\u003Cdiv class=\"js-images-slider__control-progress-item js-images-slider__control-progress-item--active\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";
};
...
pug_html = pug_html + "\u003C!DOCTYPE html\u003E\u003Chtml lang=\"en\"\u003E\u003Chead\u003E\u003Cmeta charset=\"UTF-8\"\u003E\u003Cmeta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"\u003E\u003Cmeta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"\u003E\u003Ctitle\u003ETest\u003C\u002Ftitle\u003E\u003C\u002Fhead\u003E\u003Cbody\u003E\u003Cdiv class=\"wrapper\"\u003E\u003Cdiv class=\"block\"\u003E\u003Cdiv class=\"block__bg-image ibg\"\u003E\u003Cimg" + (pug.attr("src", __webpack_require__(399), true, true)+" alt=\"image\"") + "\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"block__mask-image ibg\"\u003E\u003Cimg" + (" class=\"ibg__mask\""+pug.attr("src", __webpack_require__(172), true, true)+" alt=\"image\"") + "\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"container block__container\"\u003E\u003Cdiv class=\"block__body\"\u003E\u003Cdiv class=\"block__menu-left left-menu\"\u003E\u003Cdiv class=\"left-menu__burger\"\u003E";
pug_mixins["burger"]();
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cnav class=\"left-menu__nav\"\u003E\u003Cul class=\"left-menu__list\"\u003E\u003Cli class=\"left-menu__item\"\u003E\u003Ca class=\"left-menu__link\" href=\"changeme\"\u003E\u003Cspan\u003E01\u003C\u002Fspan\u003ESomething\u003C\u002Fa\u003E\u003Cdiv class=\"left-menu__item-border\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fli\u003E\u003Cli class=\"left-menu__item\"\u003E\u003Ca class=\"left-menu__link\" href=\"changeme\"\u003E\u003Cspan\u003E02\u003C\u002Fspan\u003ESomething\u003C\u002Fa\u003E\u003Cdiv class=\"left-menu__item-border\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fli\u003E\u003Cli class=\"left-menu__item left-menu__item--active\"\u003E\u003Ca class=\"left-menu__link\" href=\"changeme\"\u003E\u003Cspan\u003E03\u003C\u002Fspan\u003E Подсказки\u003C\u002Fa\u003E\u003Cdiv class=\"left-menu__item-border\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fli\u003E\u003Cli class=\"left-menu__item\"\u003E\u003Ca class=\"left-menu__link\" href=\"changeme\"\u003E\u003Cspan\u003E04\u003C\u002Fspan\u003ESomething\u003C\u002Fa\u003E\u003Cdiv class=\"left-menu__item-border\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fli\u003E\u003C\u002Ful\u003E\u003C\u002Fnav\u003E\u003Cdiv class=\"left-menu__scroll\"\u003E\u003Cdiv class=\"scroll-notice\"\u003E\u003Cdiv class=\"scroll-notice__text\"\u003EСкрольте вниз\u003C\u002Fdiv\u003E\u003Cdiv class=\"scroll-notice__image\"\u003E\u003Cimg" + (pug.attr("src", __webpack_require__(980), true, true)+" alt=\"\"") + "\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"block__menu-center center-menu\"\u003E\u003Cdiv class=\"center-menu__body\"\u003E\u003Cdiv class=\"center-menu__logo\"\u003E\u003Cdiv class=\"center-menu__text\"\u003EКиноПоиск\u003C\u002Fdiv\u003E\u003Cimg" + (" class=\"center-menu__icon\""+pug.attr("src", __webpack_require__(968), true, true)+" alt=\"logo\"") + "\u003E\u003C\u002Fdiv\u003E\u003Cp class=\"center-menu__content\"\u003EОНИ ДОЛЖНЫ ЧТО-ТО ЗНАТЬ\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"center-menu__middle\"\u003E\u003Cdiv class=\"center-menu__slider\"\u003E";
pug_mixins["images-slider"]([
...
pug_html = pug_html + "\u003C\u002Fdiv\u003E\u003Cbutton class=\"center-menu__button\"\u003EИскать промокод\u003Cimg" + (pug.attr("src", __webpack_require__(638), true, true)+" alt=\"\"") + "\u003E\u003C\u002Fbutton\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"block__menu-right right-menu\"\u003E\u003Ca class=\"right-menu__link\" href=\"\"\u003Ehd.kinopoisk.ru\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";;return pug_html;};
...
"use strict";
module.exports = __webpack_require__.p + "assets/img/arrow-btn.746c09789715f3573d97.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/img/arrow-next.a749475c85c86cd27802.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/img/arrow-prev.9de67cbf54fdf323e8f8.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/img/Arrow.27a3acc61a00849ad78e.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/img/logo.cfdf245256c43335a7cc.png";
...
"use strict";
module.exports = __webpack_require__.p + "assets/img/maskob.c518a0d61b844c997580.png";
...
"use strict";
module.exports = __webpack_require__.p + "assets/img/ob.a337eac335f11142e89f.jpg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/img/racer.858d62943c1b58ce5222.png";
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [671], function() { return __webpack_require__(839); })
